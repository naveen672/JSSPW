      ...
      <div className="container mx-auto px-6">
        ...
        <div className="space-y-6">
          <div className="rounded-lg border-2 border-dashed border-gray-300 dark:border-gray-700 p-12 text-center">
            <h2 className="mb-4 text-xl font-semibold text-[#0A2463] dark:text-white">Commercial Practice Program Content</h2>
            <p className="text-gray-600 dark:text-gray-400">Detailed information about the Commercial Practice program will be added here.</p>
          </div>
        </div>
      </div>
    </div>
