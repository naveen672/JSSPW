...
const NAV_LINK_CLASSES = "px-3 py-2 mx-1 text-[16px] font-bold transition-colors duration-200 ease-in-out text-gray-700 dark:text-gray-200 hover:text-[#D8315B] dark:hover:text-[#D8315B]";
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="hidden lg:flex items-center justify-end flex-1 space-x-2">
            {navItems.map((item, index) => (
              <div key={index} className="relative mx-1" ref={(el) => (dropdownRefs.current[index] = el)}>
