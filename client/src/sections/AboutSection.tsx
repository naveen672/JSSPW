    ...
    <section id="about" className="py-20">
      <div className="container mx-auto px-6">
        <div className="mx-auto mb-16 text-center">
          <h2 className="mb-4 text-3xl font-bold text-[#0A2463] md:text-4xl">About JSS Polytechnic For Women</h2>
        ...
        {/* Key Stats */}
        <div className="mt-20 grid gap-6 rounded-lg bg-[#F3F4F6] p-8 md:grid-cols-4">
          <div className="animate-on-scroll text-center">
            <Building2 className="mx-auto mb-4 h-12 w-12 text-[#3E92CC]" />
            <h4 className="mb-2 text-xl font-semibold text-[#0A2463]">Established</h4>
            <p className="text-[#1C1C1C]">Under JSS Mahavidyapeetha, a premier educational group</p>
          </div>
          
          <div className="animate-on-scroll text-center">
            <User className="mx-auto mb-4 h-12 w-12 text-[#3E92CC]" />
            <h4 className="mb-2 text-xl font-semibold text-[#0A2463]">1000+ Students</h4>
            <p className="text-[#1C1C1C]">Focused exclusively on women's technical education</p>
          </div>
          
          <div className="animate-on-scroll text-center">
            <Award className="mx-auto mb-4 h-12 w-12 text-[#3E92CC]" />
            <h4 className="mb-2 text-xl font-semibold text-[#0A2463]">#1 in Region</h4>
            <p className="text-[#1C1C1C]">For women's technical education and placement</p>
          </div>
          
          <div className="animate-on-scroll text-center">
            <GraduationCap className="mx-auto mb-4 h-12 w-12 text-[#3E92CC]" />
            <h4 className="mb-2 text-xl font-semibold text-[#0A2463]">95% Placement</h4>
            <p className="text-[#1C1C1C]">Excellent industry connections for career growth</p>
          </div>
        </div>
      </div>
    </section>
