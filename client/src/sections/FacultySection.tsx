...
const facultyData = [
  {
    ...
    bio: "Ph.D. in Computer Science from MIT with over 15 years of experience in AI research and development.",
    image: "https://images.unsplash.com/photo-1580489944761-15a19d654956?ixlib=rb-4.0.3&auto=format&fit=crop&w=500&q=80"
  },
  {
    id: 2,
    name: "Dr. Michael Johnson",
    title: "Professor, English Literature",
    bio: "Author of 12 books on modern literature, Pulitzer Prize nominee, and former Oxford fellow.",
  ...
  },
  {
    ...
    bio: "Leading researcher in biomedical engineering with patents in medical device technology.",
  ...
  },
  {
    ...
    bio: "Former Wall Street executive with expertise in international finance and emerging markets.",
    ...
    <section id="faculty" className="py-20">
      <div className="container mx-auto px-6">
        <div className="mx-auto mb-16 text-center">
          <h2 className="mb-4 text-3xl font-bold text-[#0A2463] md:text-4xl">Our Distinguished Faculty</h2>
          <div className="mx-auto h-1 w-24 bg-[#D8315B]"></div>
          <p className="mx-auto mt-6 max-w-3xl text-[#1C1C1C]">
            Learn from world-renowned experts and scholars who are leaders in their fields and dedicated to student success.
          </p>
        </div>
